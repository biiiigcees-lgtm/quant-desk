...
export class ApiServer {
  ...
  private currentState(): Record<string, unknown> {
    return this.replayEngine.deriveState() as Record<string, unknown>;
  }

  private stateAtSequence(sequence: number): Record<string, unknown> {
    return this.replayEngine.getStateAtSequence(sequence) as Record<string, unknown>;
  }
