...
export class MarketStore {
  constructor() {
    this._state = {
      ...
      feedQueueDepth: 0,
      feedDroppedStale: 0,
      feedDroppedDuplicate: 0,
      feedCommitCount: 0,
      feedMaxQueueDepth: 0,
      feedCommitLatencyMs: 0,
      feedFlushDurationMs: 0,
      updatedAt: null,
  ...
  _applyTrade(trade) {
    if (!trade || !Number.isFinite(trade.price) || trade.price <= 0) return;
    if (!Number.isFinite(trade.size) || trade.size <= 0) return;
