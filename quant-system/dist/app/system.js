...
export async function startSystem() {
    ...
    const marketDataService = new MarketDataService(eventBus, kalshiClient, logger, config.kalshi.contractIds);
    const featureEngineService = new FeatureEngineService(eventBus, logger, config.features.priceHistoryLength, {
