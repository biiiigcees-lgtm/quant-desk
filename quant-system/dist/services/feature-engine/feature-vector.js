import { ema, rsi, macd, standardDeviation, volatilityRegime, } from './indicators.js';
export function computeFeatureVector(update, priceHistory, emaPeriods, probVelocity, timeDecaySeconds) {
...
function calculateOrderBookImbalance(bids, asks) {
