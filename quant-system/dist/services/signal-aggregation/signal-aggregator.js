export function aggregateSignals(contractId, signals, weights, timestamp) {
    ...
    const regime = Object.entries(regimeVotes).sort((a, b) => b[1] - a[1])[0]?.[0] ?? 'neutral';
    return {
        contractId,
        finalSignal,
        score,
